...
class __PRIVATE_RestConnection {
  ...
  P(t, e, r, n, i) {
    ...
    const a = {};
    return this.I(a, n, i), this.V(t, o, a, r).then((e2) => (__PRIVATE_logDebug("RestConnection", `Received RPC '${t}' ${s}: `, e2), e2), (e2) => {
...
var __PRIVATE_TargetImpl = class {
  constructor(t, e = null, r = [], n = [], i = null, s = null, o = null) {
    this.path = t, this.collectionGroup = e, this.orderBy = r, this.filters = n, this.limit = i, this.startAt = s, this.endAt = o, this.N = null;
  }
};
...
var __PRIVATE_QueryImpl = class {
  ...
  constructor(t, e = null, r = [], n = [], i = null, s = "F", o = null, a = null) {
    this.path = t, this.collectionGroup = e, this.explicitOrderBy = r, this.filters = n, this.limit = i, this.limitType = s, this.startAt = o, this.endAt = a, this.O = null, // The corresponding `Target` of this `Query` instance.
...
function __PRIVATE_queryOrderBy(t) {
  ...
  if (null === e.O) {
    ...
    if (null !== t2 && null === r)
      t2.isKeyField() || e.O.push(new OrderBy(t2)), e.O.push(new OrderBy(
...
function __PRIVATE_queryToTarget(t) {
  ...
  if (!e.q)
    if ("F" === e.limitType)
      e.q = __PRIVATE_newTarget(e.path, e.collectionGroup, __PRIVATE_queryOrderBy(e), e.filters, e.limit, e.startAt, e.endAt);
    else {
      const t2 = [];
      ...
      e.q = __PRIVATE_newTarget(e.path, e.collectionGroup, t2, e.filters, e.limit, r, n);
    }
  return e.q;
}
...
var __PRIVATE_DatastoreImpl = class extends class Datastore {
  ...
  P(t, e, r) {
    return this.Z(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([n, i]) => this.connection.P(t, e, r, n, i)).catch((t2) => {
  ...
  p(t, e, r, n) {
    return this.Z(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([i, s]) => this.connection.p(t, e, r, i, s, n)).catch((t2) => {
      throw "FirebaseError" === t2.name ? (t2.code === p && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), t2) : new FirestoreError(A, t2.toString());
    });
  }
  terminate() {
...
async function __PRIVATE_invokeBatchGetDocumentsRpc(t, e) {
  ...
  }, s = await r.p("BatchGetDocuments", n, i, e.length), o = /* @__PURE__ */ new Map();
  s.forEach((t2) => {
...
async function __PRIVATE_invokeRunAggregationQueryRpc(t, e, r) {
  var n;
  const i = __PRIVATE_debugCast(t), { request: s, X: o } = function __PRIVATE_toRunAggregationQueryRequest(t2, e2, r2) {
    const n2 = __PRIVATE_toQueryTarget(t2, e2), i2 = {}, s2 = [];
    let o2 = 0;
    return r2.forEach((t3) => {
      const e3 = "aggregate_" + o2++;
      i2[e3] = t3.alias, "count" === t3.v ? s2.push({
        alias: e3,
        count: {}
      }) : "avg" === t3.v ? s2.push({
        alias: e3,
...
function doc(t, e, ...r) {
  ...
  // 'undefined' and 'null'.
  1 === arguments.length && (e = __PRIVATE_AutoId.D()), __PRIVATE_validateNonEmptyArgument("doc", "path", e), t instanceof Firestore) {
    const n = ResourcePath.fromString(e, ...r);
...
var __PRIVATE_ParseContextImpl = class ___PRIVATE_ParseContextImpl {
  ...
  _t(t) {
    return __PRIVATE_createError(t, this.settings.methodName, this.settings.lt || false, this.path, this.settings.ct);
  }
...
var __PRIVATE_TransactionRunner = class {
  ...
  Rt(t) {
    this.Et > 0 && this.It(t) ? (this.Et -= 1, this.asyncQueue.enqueueAndForget(() => (this.Tt(), Promise.resolve()))) : this.deferred.reject(t);
  }
  It(t) {
...
var __PRIVATE_AsyncQueueImpl = class {
  ...
  enqueue(t) {
    ...
    return this.Nt(() => this.wt && this.Dt ? Promise.resolve() : (t().then(e.resolve, e.reject), e.promise)).then(() => e.promise);
  }
  enqueueRetryable(t) {
  ...
  Nt(t) {
    const e = this.Vt.then(() => (this.vt = true, t().catch((t2) => {
